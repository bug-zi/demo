...
- `3.0成长系统/`——已落地（260912）：成长档案层（心/金币/经验/演示模式）/ 房内闯关梯 / 成就墙与称号 / M6 数值 pass + 版本号 3.0.0，总方案与 designs-specs 在其 `archive/`，现状见 `../project/成长系统.md`。
- `3.0人设扩充/`——进行中（260912）：13 个新人设批次内容规格（B1 情商房 6 人 ✅ 已落地；B2 杠精房 +4 / 谈判房 +3 ✅ 已落地，三房满 6；B3 冲刺批每房 +2 未设计），roster 正本在 `../3.0成长系统/archive/3.0-大版本升级总方案.md` §3.1。
- `美术升级/`——已立项·进行中（260912）：AI 生图离线管线 + 风格指南 + A1-A4 四批次资产规格（头像/背景/演出战报/徽章）。
